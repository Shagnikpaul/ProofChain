...
const deleteBill = async (req, res) => {
    ...
    try {
        const bills = await receipt.findOneAndDelete({ _id: bill_id });
...
const editBill = async (req, res) => {
    ...
    try {
        ...
        //     updatedData
        // );
        // receipt.findOneAndUpdate({ _id: bill_id }, req.body, { upsert: true });
        const updatedBill = await receipt.findByIdAndUpdate(bill_id, req.body, { upsert: true });
        console.log(updatedBill, bill_id, req.body);
